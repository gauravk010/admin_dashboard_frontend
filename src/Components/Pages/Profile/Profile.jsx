...
export const Profile = () => {
  ...
  return (
    <>
      {!Loading ? (
        <div className="bg-white flex flex-col w-[500px] max-sm:w-full mx-auto items-center rounded-sm border border-gray-200 flex-1 px-6 py-6">
          ...
          <div className="mt-4 border-b border-gray-200 w-full pb-4">
            Details
          </div>
          ...
          <Link
            ...
            className="rounded-md w-20 bg-neutral-900 text-center hover:bg-neutral-700 text-white mt-4 px-2 py-2"
          >
            Edit
          </Link>
        </div>
