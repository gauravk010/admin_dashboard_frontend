        ...
        <div className="flex items-center justify-between mt-3">
          <div className="flex items-center gap-2 justify-between">
            <div className="grid">
              ...
              <select
                className="w-40 max-sm:w-32 max-sm:text-sm appearance-none forced-colors:appearance-auto border row-start-1 col-start-1 rounded-lg focus:outline-none bg-white border-gray-200 text-gray-700 px-2 py-2"
                onChange={OnStatus}
                value={Status}
              >
